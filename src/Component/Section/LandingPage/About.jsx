...
const About = () => {
  ...
  return (
    <div id="about" className="py-[6rem] md:px-10 font-poppins" data-aos="fade-right" data-aos-duration="500">
      ...
      <div className="flex w-full flex-col md:flex-row items-center justify-center">
        <div className="md:ml-8 p-20 ml-12">
          <img src={avatar} alt="my profile" className="w-[300px]" />
        </div>
        <div className="flex w-full md:w-1/2  justify-start px-10 py-10 flex-col md:px-16">
