    ...
    <div className="min-h-screen py-[5rem] md:px-10 font-poppins" >
      ...
      <div className="flex justify-center items-center text-center flex-wrap" >
        {services.map((service) => (
          <div key={service.name} className={`mt-6 ${service.bg} items-center rounded-md md:h-96 p-8 md:ml-4 mx-5 md:w-80 text-white justify-center`} data-aos="fade-left" data-aos-duration="3000">
