  ...
  return (
    <footer className="bg-custom-blue text-white font-poppins">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 py-7">
        <h1 className="lg:text-3xl md:text-2xl md:mb-0 lg:leading-normal font-semibold md:w-2/5"><span className="text-custom-red">Penuhi </span>kebutuhanmu dengan skill yang saya punya</h1>
        <div className="">
      ...
      <div className="text-center grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 px-10 py-9">
        <span>Copyright ©2033 - {new Date().getFullYear()} KikukCode - All right reserved</span>
      </div>
    </footer>
  )
}
